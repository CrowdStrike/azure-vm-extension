      ...
      then: {
        ...
        details: {
          ...
          roleDefinitionIds: [
            ...
            subscriptionResourceId('Microsoft.Authorization/roleDefinitions', managedIdentityOperatorRoleId)
          ]
          deployment: {
            properties: {
              mode: 'incremental'
    ...
    policyRule: {
      ...
      then: {
        ...
        details: {
          ...
          roleDefinitionIds: [
            subscriptionResourceId('Microsoft.Authorization/roleDefinitions', arcRoleDefinitionId)
          ]
          deployment: {
            properties: {
              mode: 'incremental'
